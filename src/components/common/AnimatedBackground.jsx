...
const AnimatedBackground = ({ darkMode, currentTheme }) => {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
      <svg 
        ...
        style={{ enableBackground: 'new 0 0 1820 1080', width: '100%', height: '100%' }} 
        xmlSpace="preserve"
      >
        <defs>
          ...
          <style>
            {`
              ...
              .red-lines {
                fill: none;
                opacity: 0.12;
                stroke: ${theme.secondary || theme.button};
                stroke-width: 12;
                stroke-miterlimit: 10;
                animation: show 4s ease-in-out infinite;
              }
